...
class BackendConfiguration(configparser.ConfigParser):
    ...
    _DEFAULT_CONFIG = {
        _MODE_SECTION: {
            ...
            _FALLBACK: BackendMode.SteamWebApi.value,
        }
    }
    ...
    _INFO_HEADER = (
        dedent(
            ...
            ; initial - the operation mode in which the plugin starts; default: steam_network; possible values: steam_network, public_profiles, steam_webapi
            ; fallback - the operation mode to switch to in case of failure in the initial mode; default: public_profiles; possible values: steam_network, public_profiles, steam_webapi, none
            ;
            ;
            ; EXAMPLE:
            ;
